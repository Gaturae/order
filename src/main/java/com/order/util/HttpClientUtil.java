...
/**
 * 
 * @classDesc: 功能描述:(HttpClientUtil)
 * @author: 王浩
 * @createTime: 2017年5月10日 下午8:03:20
 * @version: v1.0
...
public class HttpClientUtil extends BaseController {
	 ...
	 * @param: @throws
	 *             Exception
	 * @createTime:2017年5月19日 下午2:05:13
	 * @returnType:@param urlStr
	 * @returnType:@param params
	 * @returnType:@return
	 * @returnType:@throws Exception String
	 * @copyright:善林(上海)金融信息服务有限公司
	 */
