 ...
 * @classDesc: 功能描述:(反射工具)
 * @author: 王浩
 * @createTime: 2017年5月10日 上午11:24:33
 * @version: v1.0
...
public class ReflectTool {
	...
	public static Object invoke(Object obj, String methodName, Class classes, Object args) {
		...
		try {
			...
			log.error("invoke error:" + obj.getClass() + "." + methodName + "," + e.getMessage() + "," + classes + "->"
					+ args.getClass());
		}
		return returnObj;
	}
	...
	public static void setAttribute(Object obj, String attName, Object attValue) {
		...
		try {
			...
			log.debug("field:" + field.getName() + " reflect failure!");
	...
	public static Field[] getAllSimpleField(Class clazz) {
		...
		for (Field f : superFields) {
			...
			if (isRepeat == false) {
				...
				if (ListTool.isInList(f.getName(), ReflectTool.exampleTypes)) {
