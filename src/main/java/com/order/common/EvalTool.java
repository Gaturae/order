...
/**
 * 
 * @classDesc: 功能描述:(表达式执行工具 使用自定类EL表达式 $[x.y.z])
 * @author: 王浩
 * @createTime: 2017年5月10日 上午11:23:44
 * @version: v1.0
	...
	public static String evalString(Object fromObj, String el) {
		try {
			...
			for (String elExpress : elList) {
				...
				innerEl = innerEl.replaceAll("\\]", "");
				temp = EvalTool.evalObject(fromObj, innerEl) == null ? ""
						: EvalTool.evalObject(fromObj, innerEl).toString();
